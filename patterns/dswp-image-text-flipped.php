 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|70","right":"var:preset|spacing|70"}}},"className":"dswp-text-image-flipped-block-custom-layout","layout":{"type":"constrained"},"metadata":{"categories":["banner"],"patternName":"design-system-wordpress-theme/dswp-image-text","name":"DSWP Image \u0026 Text Flipped"}} -->
<div
    class="wp-block-group dswp-text-image-flipped-block-custom-layout"
    style="
        margin-top: 0;
        margin-bottom: 0;
    ...
    <div
        ...
        <div
            ...
            style="padding-right: 0; padding-left: 0; flex-basis: 58%"
            ><!-- wp:group {"style":{"layout":{"columnSpan":5,"rowSpan":1},"spacing":{"padding":{"right":"0","left":"0"}}},"layout":{"type":"flex","orientation":"vertical"}} -->
            <div
        ...
        <div
            ...
            style="
                ...
                flex-basis: 26%;
            "
            ><!-- wp:image {"id":476,"width":"198px","sizeSlug":"full","linkDestination":"none"} -->
