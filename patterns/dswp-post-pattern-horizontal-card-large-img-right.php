...
<figure class="wp-block-image size-full"><img src="https://localhost/wp-content/themes/design-system-wordpress-theme/assets/images/square-512.png" alt="" class="wp-image-15586"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
