...
<div
    class="wp-block-group alignfull dswp-team-pattern"
    ...
    <div
        ...
        ><!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|60","left":"var:preset|spacing|60","top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
        <div
            ...
            <div
                ...
                ><!-- wp:column {"verticalAlignment":"center","width":"18%","style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"default"}} -->
                <div
                    class="wp-block-column is-vertically-aligned-center"
                    style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; flex-basis: 18%"
                    ><!-- wp:image {"id":15402,"width":"180px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"left","className":"is-style-rounded"} -->
                    <figure class="wp-block-image alignleft size-full is-resized is-style-rounded"
                        ><img
                            src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/square-512.png' ); ?>"
                            alt=""
                            class="wp-image-15402"
                            style="aspect-ratio: 1; object-fit: cover; width: 180px"
                    /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
