    ...
    <div
        ...
        <div
            ...
            <div
                ...
                ><!-- wp:columns {"verticalAlignment":"center","className":"dswp-columns","style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"padding":{"right":"0","left":"0"},"blockGap":{"left":"var:preset|spacing|80"}}}} -->
                <div
                    class="wp-block-columns are-vertically-aligned-center dswp-columns"
                    style="margin-top: var(--wp--preset--spacing--50); margin-bottom: var(--wp--preset--spacing--50); padding-right: 0; padding-left: 0"
                    ...
                    <div
                        class="wp-block-column is-vertically-aligned-center dswp-information-contact-socials-card"
                        ...
                        <div
                            class="wp-block-group dswp-information-contact-socials-card-content"
                            ...
                            <div
                                ...
                                <div class="wp-block-group dswp-information-contact-socials-card-img-group"
                                    ><!-- wp:image {"id":16734,"width":"28px","height":"auto","sizeSlug":"full","linkDestination":"none","className":"dswp-information-contact-socials-card-img size-full is-resized is-style-default"} -->
                                    <figure class="wp-block-image size-full is-resized dswp-information-contact-socials-card-img is-style-default"
                                        ><img
                                            src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/square-256.png' ); ?>"
                                            alt=""
                                            class="wp-image-16734"
