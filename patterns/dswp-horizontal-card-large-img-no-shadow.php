...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--80);margin-bottom:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:columns {"templateLock":false,"lock":{"move":false,"remove":false},"align":"wide","className":"dswp-horizontal-card-large-img-no-shadow","style":{"border":{"width":"0px","style":"none"},"spacing":{"blockGap":{"top":"var:preset|spacing|50"}}}} -->
    <div class="wp-block-columns alignwide dswp-horizontal-card-large-img-no-shadow" style="border-style:none;border-width:0px"><!-- wp:column {"verticalAlignment":"center","width":"60%","style":{"spacing":{"padding":{"top":"0","bottom":"0","right":"var:preset|spacing|40","left":"0"}}},"layout":{"type":"default"}} -->
        <div class="wp-block-column is-vertically-aligned-center" style="padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:0;flex-basis:60%"><!-- wp:heading {"className":"is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|60"}},"elements":{"link":{"color":{"text":"var:preset|color|font dark"}}}},"textColor":"font dark"} -->
            <h2 class="wp-block-heading is-style-default has-font-dark-color has-text-color has-link-color" id="strong-neque-porro-quisquamsed-strong" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--60)"><strong>Neque porro quisquamSed</strong></h2>
            <!-- /wp:heading -->
            ...
            <div class="wp-block-group"><!-- wp:heading {"level":5,"className":"is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|font dark"}}}},"textColor":"font dark"} -->
                <h5 class="wp-block-heading is-style-default has-font-dark-color has-text-color has-link-color" id="neque-porro-quisquamsed" style="margin-top:0;margin-bottom:0">Neque porro quisquamSed</h5>
                <!-- /wp:heading -->
        ...
        <div class="wp-block-column is-vertically-aligned-top dswp-image-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:40%"><!-- wp:image {"id":13862,"width":"500px","aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"size-full"} -->
            <figure class="wp-block-image size-large is-resized size-full"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/square-512.png' ); ?>" alt="" class="wp-image-13862" style="aspect-ratio:1;object-fit:cover;width:500px" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
